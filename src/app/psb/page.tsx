    ...
    <div className="pt-32 pb-24 min-h-screen bg-white">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center max-w-5xl">
        ...
        <div className="mt-16 bg-brand-primary text-white p-12 md:p-20 rounded-[3rem] shadow-2xl relative overflow-hidden text-left border border-brand-primary lg:mx-12">
          {/* Abstract blobs */}
          <div className="absolute -top-32 -right-32 w-96 h-96 bg-brand-accent/30 rounded-full blur-[100px] pointer-events-none"></div>
          <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-brand-lime/20 rounded-full blur-[100px] pointer-events-none"></div>
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <ol className="w-full space-y-6 max-w-2xl mx-auto mb-16">
              {[
                ...
                <li key={i} className="flex gap-6 items-start bg-white/5 p-6 rounded-2xl border border-white/10 backdrop-blur-sm">
                  <div className="w-10 h-10 rounded-full bg-brand-accent text-brand-primary flex shrink-0 items-center justify-center font-bold text-lg shadow-lg">
                    {i + 1}
                  </div>
            ...
            <PremiumButton href="#" variant="primary" className="px-12 py-5 text-lg w-full md:w-auto shadow-xl shadow-brand-accent/20">
