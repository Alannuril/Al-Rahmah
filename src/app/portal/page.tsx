        ...
        <div className="mt-12 bg-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl relative border border-gray-100">
          <form className="flex flex-col gap-6 text-left">
            <div>
              ...
              <input type="text" className="w-full px-5 py-3.5 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brand-accent focus:border-brand-accent transition-all text-brand-primary font-medium" placeholder="Masukkan ID Anda" />
            </div>
            <div>
              <label className="block text-sm font-bold text-brand-primary mb-2">Password</label>
              <input type="password" className="w-full px-5 py-3.5 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brand-accent focus:border-brand-accent transition-all text-brand-primary font-medium" placeholder="••••••••" />
            </div>
            <div className="flex items-center justify-between mt-1">
              <label className="flex items-center gap-2 text-sm text-brand-primary/70 font-medium font-sans">
                <input type="checkbox" className="rounded text-brand-accent focus:ring-brand-accent border-gray-300 w-4 h-4 cursor-pointer" />
                Ingat Saya
              </label>
              <a href="#" className="text-sm font-bold text-brand-primary hover:text-brand-accent transition-colors">Lupa Password?</a>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 text-xs text-brand-primary/50 font-medium">
            <span className="text-brand-accent font-bold">INFO:</span> Portal ini terintegrasi dengan data akademik dan asrama secara real-time.
          </div>
        </div>
      </div>
    </div>
