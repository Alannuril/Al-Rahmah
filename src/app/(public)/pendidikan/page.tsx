        ...
        <div className="mt-20 space-y-16">
          <div className="flex flex-col md:flex-row gap-12 items-center bg-brand-paper border border-gray-100 rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-brand-primary/5">
            ...
            <div className="md:w-1/2 px-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-secondary/20 text-brand-primary rounded-full mb-6">
              ...
              <h3 className="font-heading text-4xl font-bold text-brand-primary mb-6 leading-tight">Madrasah Aliyah <br/><span className="text-brand-secondary">Al-Rahmah</span></h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-white shadow-md flex items-center justify-center text-brand-secondary shrink-0"><BookOpen size={20}/></div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-white shadow-md flex items-center justify-center text-brand-secondary shrink-0"><Beaker size={20}/></div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-white shadow-md flex items-center justify-center text-brand-secondary shrink-0"><Globe size={20}/></div>
                  <div>
