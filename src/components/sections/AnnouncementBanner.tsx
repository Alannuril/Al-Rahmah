...
export async function AnnouncementBanner() {
  ...
  return (
    <ScrollReveal variant="fade-down" duration={0.5} className="w-full relative z-20">
      <aside aria-label="Pengumuman Penting" className="w-full bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 text-white shadow-md">
