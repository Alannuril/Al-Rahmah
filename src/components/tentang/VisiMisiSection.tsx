...
export function VisiMisiSection() {
  return (
    <section id="visi-misi" aria-labelledby="visi-misi-heading" className="scroll-mt-24">
      <div className="bg-brand-primary py-10 text-white sm:py-12">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
            <div className="border-l-2 border-brand-lime pl-5 sm:pl-6">
              <h3 id="visi-heading" className="mb-4 text-sm font-semibold text-white/90">
                Visi Pesantren
              </h3>
            ...
            <figure>
              ...
              <figcaption className="mt-3 text-xs leading-5 text-white/90">
      ...
      <section aria-labelledby="misi-heading" className="mx-auto grid max-w-6xl gap-6 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-12 lg:gap-12 lg:px-8">
        <h3 id="misi-heading" className="font-heading text-xl font-semibold text-brand-primary lg:col-span-4">
          Misi Lembaga
        </h3>
        <ol className="divide-y divide-brand-primary/15 lg:col-span-8">
          {MISI_LIST.map((misi) => (
