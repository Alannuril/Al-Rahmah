...
export function Footer() {
  return (
    <footer className="bg-brand-primary text-white pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-secondary/5 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <Link href="/" className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-brand-primary flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                A
              </div>
            ...
            <div className="flex items-center gap-3 mt-2">
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-brand-secondary hover:text-white hover:border-brand-secondary transition-all duration-300">
                <Camera size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-brand-secondary hover:text-white hover:border-brand-secondary transition-all duration-300">
                <Globe size={18} />
          ...
          <div className="lg:col-span-2 lg:col-start-6">
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li><Link href="/santri" className="text-white/70 hover:text-brand-secondary transition-colors text-sm">Kehidupan Santri</Link></li>
              <li><Link href="/galeri" className="text-white/70 hover:text-brand-secondary transition-colors text-sm">Galeri Kegiatan</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li><Link href="/portal" className="text-white/70 hover:text-brand-secondary transition-colors text-sm">Portal Madrasah</Link></li>
              <li><Link href="/karir" className="text-white/70 hover:text-brand-secondary transition-colors text-sm">Karir</Link></li>
              <li><Link href="/faq" className="text-white/70 hover:text-brand-secondary transition-colors text-sm">FAQ</Link></li>
            </ul>
          </div>
